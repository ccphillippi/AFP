# -*- coding: utf-8 -*-
#
# afp documentation build configuration file, created by
# sphinx-quickstart on Sat Feb 08 21:57:20 2014.
#
...
MOCK_MODULES = ['numpy', 'scipy', 'scipy.sparse', 'ystockquote', 'pandas' ]
...
sys.path.insert(0, os.path.abspath('../afp'))
